...
#define COIN_MAX_PREFIX (MAX(sizeof(COIN_PRIMARY_PREFIX), sizeof(COIN_SECONDARY_PREFIX)))
#define ACCOUNT_BUF_LEN (LIBN_ACCOUNT_STRING_BASE_LEN + COIN_MAX_PREFIX + 1)
...
union {
    struct {
        ...
        char openLabel[sizeof(OPEN_LABEL_PREFIX) + sizeof(COIN_NAME) + sizeof(OPEN_LABEL_SUFFIX) +
                       1];
    } idle;
    struct {
    } settings;
...
const bagl_element_t ui_idle[] = {
    ...
    {{/* type */ BAGL_RECTANGLE,
      ...
      /* radius */ 0,
      /* fill */ BAGL_FILL,
      /* fgcolor */ COIN_COLOR_ALT_BG,
      /* bgcolor */ COIN_COLOR_ALT_BG,
      /* font_id */ 0,
      /* icon_id */ 0},
     /* text */ NULL,
     /* touch_area_brim */ 0,
    ...
    {{/* type */ BAGL_RECTANGLE,
      ...
      /* radius */ 0,
      /* fill */ BAGL_FILL,
      /* fgcolor */ COIN_COLOR_BG,
      /* bgcolor */ COIN_COLOR_BG,
      /* font_id */ 0,
      /* icon_id */ 0},
     /* text */ NULL,
     /* touch_area_brim */ 0,
    ...
    {{/* type */ BAGL_LABELINE,
     ...
     /* out */ NULL,
     /* over */ NULL},
    {{/* type */ BAGL_RECTANGLE | BAGL_FLAG_TOUCHABLE,
      /* userid */ 0x00,
      /* x */ 0,
      /* y */ 19,
      /* width */ 56,
      ...
      /* fill */ BAGL_FILL,
      /* fgcolor */ COIN_COLOR_ALT_BG,
      /* bgcolor */ COIN_COLOR_ALT_FG,
      /* font_id */ BAGL_FONT_SYMBOLS_0 | BAGL_FONT_ALIGNMENT_CENTER | BAGL_FONT_ALIGNMENT_MIDDLE,
      /* scrollspeed */ 0},
     /* text */ BAGL_FONT_SYMBOLS_0_SETTINGS,
     /* touch_area_brim */ 0,
     /* overfgcolor */ COIN_COLOR_ALT_BG,
     /* overbgcolor */ COIN_COLOR_ALT_FG,
     /* tap */ ui_touch_settings,
     /* out */ NULL,
     /* over */ NULL},
    {{/* type */ BAGL_RECTANGLE | BAGL_FLAG_TOUCHABLE,
      /* userid */ 0x00,
      ...
      /* font_id */ BAGL_FONT_SYMBOLS_0 | BAGL_FONT_ALIGNMENT_CENTER | BAGL_FONT_ALIGNMENT_MIDDLE,
      /* scrollspeed */ 0},
     /* text */ BAGL_FONT_SYMBOLS_0_DASHBOARD,
     /* touch_area_brim */ 0,
     /* overfgcolor */ COIN_COLOR_ALT_BG,
     /* overbgcolor */ COIN_COLOR_ALT_FG,
     /* tap */ ui_touch_exit,
    ...
    {{/* type */ BAGL_ICON,
      ...
      /* radius */ 0,
      /* fill */ BAGL_FILL,
      /* fgcolor */ COIN_COLOR_FG,
      /* bgcolor */ COIN_COLOR_BG,
      /* font_id */ 0,
      /* icon_id */ 0},
     /* text */ (char *) COIN_BADGE,
     /* touch_area_brim */ 0,
     /* overfgcolor */ 0,
     /* overbgcolor */ 0,
     /* tap */ NULL,
    ...
    {{/* type */ BAGL_LABELINE,
      ...
      /* scrollspeed */ 0},
     /* text */ "Connect the Ledger Blue and open your",
     /* touch_area_brim */ 0,
     /* overfgcolor */ 0,
     /* overbgcolor */ 0,
     /* tap */ NULL,
    ...
    {{/* type */ BAGL_LABELINE,
      ...
      /* font_id */ BAGL_FONT_OPEN_SANS_REGULAR_10_13PX | BAGL_FONT_ALIGNMENT_CENTER,
      /* scrollspeed */ 0},
     /* text */ "preferred wallet to view your accounts.",
     /* touch_area_brim */ 0,
     /* overfgcolor */ 0,
     /* overbgcolor */ 0,
     /* tap */ NULL,
    ...
    {{/* type */ BAGL_LABELINE,
      ...
      /* scrollspeed */ 0},
     /* text */ "Approval requests will show automatically.",
     /* touch_area_brim */ 0,
     /* overfgcolor */ 0,
     /* overbgcolor */ 0,
     /* tap */ NULL,
...
const bagl_element_t ui_settings[] = {
    ...
    {{/* type */ BAGL_LABELINE,
      ...
      /* scrollspeed */ 0},
     /* text */ "No confirmation for receive transactions",
     /* touch_area_brim */ 0,
     /* overfgcolor */ 0,
     /* overbgcolor */ 0,
     /* tap */ NULL,
     /* out */ NULL,
     /* over */ NULL},
    {{/* type */ BAGL_NONE | BAGL_FLAG_TOUCHABLE,
      /* userid */ 0x00,
      /* x */ 0,
      /* y */ 78,
      /* width */ 320,
    ...
    {{/* type */ BAGL_LABELINE,
      ...
      /* font_id */ BAGL_FONT_OPEN_SANS_REGULAR_8_11PX,
      /* scrollspeed */ 0},
     /* text */ "https://github.com/roosmaa/blue-app-nano",
     /* touch_area_brim */ 0,
     /* overfgcolor */ 0,
     /* overbgcolor */ 0,
     /* tap */ NULL,
    ...
    {{/* type */ BAGL_ICON,
      ...
      /* font_id */ 0,
      /* icon_id */ 0},
     /* text */ (char *) COIN_ICON_TOGGLE_OFF,
     /* touch_area_brim */ 0,
     /* overfgcolor */ 0,
     /* overbgcolor */ 0,
     /* tap */ NULL,
...
const bagl_element_t *ui_settings_prepro(const bagl_element_t *e) {
    ...
    switch (e->component.userid) {
        case 0x01:
            ...
            mutableElement.text =
                (const char *) (N_libn.autoReceive ? COIN_ICON_TOGGLE_ON : COIN_ICON_TOGGLE_OFF);
...
void libn_bagl_settings(void) {
    ...
    const bool quickRedaw = UX_DISPLAYED() && ux.elements == ui_settings &&
...
const bagl_element_t ui_confirm_address[] = {
    ...
    {{/* type */ BAGL_LABELINE,
      ...
      /* font_id */ BAGL_FONT_OPEN_SANS_REGULAR_10_13PX | BAGL_FONT_ALIGNMENT_CENTER,
      /* scrollspeed */ 0},
     /* text */ vars.displayAddress.address.lines.first,
     /* touch_area_brim */ 0,
     /* overfgcolor */ 0,
     /* overbgcolor */ 0,
     /* tap */ NULL,
    ...
    {{/* type */ BAGL_LABELINE,
      ...
      /* font_id */ BAGL_FONT_OPEN_SANS_REGULAR_10_13PX | BAGL_FONT_ALIGNMENT_CENTER,
      /* scrollspeed */ 0},
     /* text */ vars.displayAddress.address.lines.second,
     /* touch_area_brim */ 0,
     /* overfgcolor */ 0,
     /* overbgcolor */ 0,
     /* tap */ NULL,
    ...
    {{/* type */ BAGL_RECTANGLE | BAGL_FLAG_TOUCHABLE,
      ...
      /* radius */ 18,
      /* fill */ BAGL_FILL,
      /* fgcolor */ COIN_COLOR_REJECT_BG,
      /* bgcolor */ COIN_COLOR_REJECT_FG,
      /* font_id */ BAGL_FONT_OPEN_SANS_REGULAR_11_14PX | BAGL_FONT_ALIGNMENT_CENTER |
          BAGL_FONT_ALIGNMENT_MIDDLE,
      /* icon_id */ 0},
     /* text */ "REJECT",
     /* touch_area_brim */ 0,
     /* overfgcolor */ COIN_COLOR_REJECT_OVER_BG,
     /* overbgcolor */ COIN_COLOR_REJECT_OVER_FG,
     /* tap */ ui_touch_reject,
     /* out */ NULL,
     /* over */ NULL},
    {{/* type */ BAGL_RECTANGLE | BAGL_FLAG_TOUCHABLE,
      ...
      /* radius */ 18,
      /* fill */ BAGL_FILL,
      /* fgcolor */ COIN_COLOR_CONFIRM_BG,
      /* bgcolor */ COIN_COLOR_CONFIRM_FG,
      /* font_id */ BAGL_FONT_OPEN_SANS_REGULAR_11_14PX | BAGL_FONT_ALIGNMENT_CENTER |
          BAGL_FONT_ALIGNMENT_MIDDLE,
      /* icon_id */ 0},
     /* text */ "CONFIRM",
     /* touch_area_brim */ 0,
     /* overfgcolor */ COIN_COLOR_CONFIRM_OVER_BG,
     /* overbgcolor */ COIN_COLOR_CONFIRM_OVER_FG,
...
void libn_bagl_confirm_address(void) {
    ...
    ui_write_split_address(&req->addressFormatter, &vars.displayAddress.address, req->publicKey);
...
const bagl_element_t ui_confirm_block[] = {
    ...
    {{/* type */ BAGL_LABELINE,
      ...
      /* font_id */ BAGL_FONT_OPEN_SANS_REGULAR_10_13PX | BAGL_FONT_ALIGNMENT_CENTER,
      /* scrollspeed */ 0},
     /* text */ vars.confirmSignBlock.accountAddress,
     /* touch_area_brim */ 0,
     /* overfgcolor */ 0,
     /* overbgcolor */ 0,
     /* tap */ NULL,
    ...
    {{/* type */ BAGL_LABELINE,
      ...
      /* font_id */ BAGL_FONT_OPEN_SANS_SEMIBOLD_8_11PX | BAGL_FONT_ALIGNMENT_CENTER,
      /* scrollspeed */ 0},
     /* text */ vars.confirmSignBlock.amountLabel,
     /* touch_area_brim */ 0,
     /* overfgcolor */ 0,
     /* overbgcolor */ 0,
     /* tap */ NULL,
    ...
    {{/* type */ BAGL_LABELINE,
      ...
      /* font_id */ BAGL_FONT_OPEN_SANS_REGULAR_10_13PX | BAGL_FONT_ALIGNMENT_CENTER,
      /* scrollspeed */ 0},
     /* text */ vars.confirmSignBlock.amountValue,
     /* touch_area_brim */ 0,
     /* overfgcolor */ 0,
     /* overbgcolor */ 0,
     /* tap */ NULL,
    ...
    {{/* type */ BAGL_LABELINE,
      ...
      /* font_id */ BAGL_FONT_OPEN_SANS_REGULAR_10_13PX | BAGL_FONT_ALIGNMENT_CENTER,
      /* scrollspeed */ 0},
     /* text */ vars.confirmSignBlock.blockHash,
     /* touch_area_brim */ 0,
     /* overfgcolor */ 0,
     /* overbgcolor */ 0,
     /* tap */ NULL,
...
void libn_bagl_confirm_block(void) {
    ...
    ui_write_address_truncated(&req->addressFormatter,
                               vars.confirmSignBlock.accountAddress,
                               req->publicKey);

    if (!libn_is_zero(req->amount, sizeof(req->amount))) {
        libn_amount_format(&req->amountFormatter,
        ...
        if (!libn_is_zero(req->recipient, sizeof(req->recipient))) {
            ...
            ui_write_split_address(&req->recipientFormatter,
    ...
    if (!libn_is_zero(req->representative, sizeof(req->representative))) {
        ui_write_split_address(&req->representativeFormatter,
