...
// const char *const settings_auto_receive_getter_values[] = {"Disabled", "Enabled", "Back"};
...
//                                     settings_auto_receive_getter,
//                                     settings_auto_receive_selector,
//                                     N_libn.autoReceive ? 1 : 0);
//             break;
//         default:
...
// UX_STEP_CB(ux_about_flow_1_step,
//            nn,
...
//                "application",
//            });
// UX_STEP_CB(ux_about_flow_2_step,
//            bn,
//            ux_flow_init(0, ux_idle_flow, &ux_idle_flow_3_step),
//            {
//                "Developer",
//                "Mart Roosmaa",
//            });
// UX_STEP_CB(ux_about_flow_3_step,
//            bnnn,
//            ux_flow_init(0, ux_idle_flow, &ux_idle_flow_3_step),
//            {
//                "Source code",
...
//                "app-nano",
//            });
// UX_STEP_CB(ux_about_flow_4_step,
//            pb,
//            ux_flow_init(0, ux_idle_flow, &ux_idle_flow_3_step),
//            {
//                &C_icon_close,
...
//     ui_write_address_full(&req->addressFormatter, vars.displayAddress.account, req->publicKey);
...
//  * Confirm sign block
//  */
// UX_STEP_NOCB(ux_confirm_sign_block_flow_1_step,
//              pnn,
//              {
//                  &C_icon_eye,
//                  "Review",
//                  "transaction",
//              });
// UX_STEP_NOCB_INIT(ux_confirm_sign_block_flow_2_step,
//                   bn,
//                   {
//                       libn_apdu_sign_block_request_t *req =
//                           &libn_context_D.stateData.signBlockRequest;
...
//                       vars.confirmSignBlock.textBuf,
//                   });
// UX_STEP_NOCB_INIT(ux_confirm_sign_block_flow_3_step,
//                   bn,
//                   {
//                       libn_apdu_sign_block_request_t *req =
//                           &libn_context_D.stateData.signBlockRequest;
...
//                       vars.confirmSignBlock.textBuf,
//                   });
// UX_STEP_NOCB_INIT(ux_confirm_sign_block_flow_4_step,
//                   bnnn_paging,
//                   {
//                       libn_apdu_sign_block_request_t *req =
//                           &libn_context_D.stateData.signBlockRequest;
//                       ui_write_address_full(&req->recipientFormatter,
//                                             vars.confirmSignBlock.textBuf,
//                                             req->recipient);
//                   },
//                   {
...
//                       vars.confirmSignBlock.textBuf,
//                   });
// UX_STEP_NOCB_INIT(ux_confirm_sign_block_flow_5_step,
//                   bnnn_paging,
//                   {
//                       libn_apdu_sign_block_request_t *req =
//                           &libn_context_D.stateData.signBlockRequest;
//                       ui_write_address_full(&req->representativeFormatter,
//                                             vars.confirmSignBlock.textBuf,
//                                             req->representative);
//                   },
//                   {
...
//                       vars.confirmSignBlock.textBuf,
//                   });
// UX_STEP_NOCB_INIT(ux_confirm_sign_block_flow_6_step,
//                   bn,
//                   {
//                       libn_apdu_sign_block_request_t *req =
//                           &libn_context_D.stateData.signBlockRequest;
...
//                       vars.confirmSignBlock.textBuf,
//                   });
// UX_STEP_CB(ux_confirm_sign_block_flow_7_step,
//            pbb,
...
//                "and sign",
//            });
// UX_STEP_CB(ux_confirm_sign_block_flow_8_step,
//            pb,
...
//     if (showRepresentative) ux_confirm_sign_block_flow[step++] =
//     &ux_confirm_sign_block_flow_5_step; ux_confirm_sign_block_flow[step++] =
//     &ux_confirm_sign_block_flow_6_step; ux_confirm_sign_block_flow[step++] =
//     &ux_confirm_sign_block_flow_7_step; ux_confirm_sign_block_flow[step++] =
//     &ux_confirm_sign_block_flow_8_step; ux_confirm_sign_block_flow[step++] = FLOW_END_STEP;
